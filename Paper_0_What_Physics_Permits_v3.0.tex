...
The single most common misreading of \PLEC{} is to treat the $\argmin$ as the output of an optimization \emph{process}. On this misreading, the framework describes a world in which something---nature, the universe, physical reality---is computing a minimum at each moment and delivering the result. That misreading imports an unstated dynamical and agential structure that the framework does not commit to.
