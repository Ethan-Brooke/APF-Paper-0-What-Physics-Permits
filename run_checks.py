...
This is the standalone-repo verifier for What Physics Permits (APF Paper 0).
...
verifies the 20-theorem subset directly cited by the manuscript.
"""
...
def main():
    ...
    print()
    print("=" * 72)
    print(f"  Paper 0 ({{What Physics Permits}}): {passed} passed, {failed} failed, "
