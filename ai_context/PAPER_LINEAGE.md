# PAPER_LINEAGE.md — Version History for Paper 0

This file tracks the version history of Paper 0 (What Physics Permits: An Ontology for Admissibility Physics) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.
...
- **Concept DOI:** 10.5281/zenodo.18605692
...
- **v3.0** (current): see the main paper's changelog section for details.
...
**vv3.0 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v3.0** (current): see the main paper's changelog section for details.
