...
> Brooke, E. S. (2026). *What Physics Permits: An Ontology for Admissibility Physics*. Version v3.0. Zenodo. https://doi.org/10.5281/zenodo.18605692
...
@misc{brooke_paper0_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18605692}
}
```

The DOI `10.5281/zenodo.18605692` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
